...
function AddSalesInvoice() {
  ...
  //   let totaldiscper = 0;
  //   let totaltax = 0;
  //   let totalOtherCharges = parseFloat(invoiceData.OtherCharge) || 0;
  //   // const otherCharges = parseFloat(invoiceData.OtherCharge) || 0;
  //   // const cashDiscount = parseFloat(invoiceData.CashDiscount) || 0;
  ...
  //     const qty = parseFloat(item.Qty) || 0;
  //     const net = parseFloat(item.Net) || 0;
  //     const discper = parseFloat(item.DiscPercent) || 0;
  //     const othercharge = parseFloat(item.OtherCharge) || 0;
  ...
  //     // grandTotal += otherCharges - cashDiscount;
  //     // grandTotal += (gross - disc) + cgstAmount + sgstAmount + igstAmount + cessAmount+taxAmount;
  //     grandTotal = totalGross - totalDiscount + totalCGST + totalSGST + totalIGST + totalCess + totalOtherCharges;
  //   });
  ...
  //     Disc: parseFloat(totalDiscount.toFixed(2)),
  //     CGST: parseFloat(totalCGST.toFixed(2)),
  //     Net: parseFloat(totalnet.toFixed(2)),
  //     SGST: parseFloat(totalSGST.toFixed(2)),
  //     IGST: parseFloat(totalIGST.toFixed(2)),
  //     Total: parseFloat((totalGross - totalDiscount).toFixed(2)),
  //     DiscPercent: parseFloat(totaldiscper.toFixed(2)),
  //     Qty: parseFloat(totalQty.toFixed(0)),
  //     Cess: parseFloat(totalCess.toFixed(2)),
  //     GrandTotal: parseFloat(grandTotal.toFixed(2)),
  //     OtherCharge: parseFloat(totalOtherCharges.toFixed(2)),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://assurelite.datacubeglobal.com/Api/index.php/Entries/add_bill', data, {
        headers: {

...
function AddSalesQuotation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://assurelite.datacubeglobal.com/Api/index.php/Entries/add_Quotation', data, {
        headers: {
      ...
      <div className="main-content">
        <div className="page-content">
          <div className="container-fluid">
            <PageHead master="Sales" head="Add Sales Quotation" />
            <div className="row">

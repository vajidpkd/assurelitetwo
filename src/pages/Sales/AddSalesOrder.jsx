...
function AddSalesOrder() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://assurelite.datacubeglobal.com/Api/index.php/Entries/add_SalesOrder', data, {
        headers: {
      ...
      <div className="main-content">
        <div className="page-content">
          <div className="container-fluid">
            <PageHead master="Sales" head="Add Sales Order" />
            <div className="row">

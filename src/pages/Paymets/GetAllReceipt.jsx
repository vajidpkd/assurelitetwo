...
// import { getAllPayment, getAllReceipt } from 'api/api';
import { DeleteOutlined, EditOutlined } from '@ant-design/icons';
import axios from 'axios';
import { getAllReceipt } from 'api/apis/accountmaster';
...
export default function ViewReceipt() {
  ...
  const handleDelete = async (RefNo) => {
    try {
      await axios.put(`https://assurelite.datacubeglobal.com/Api/index.php/Entries/delete_Receipt?RefNo=${RefNo}`);
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      try {
        const data = await getAllReceipt();
      ...
      <MainCard>
        <div className="container mx-auto rounded-md bg-white p-10">
          <div className="flex justify-between">
            <Typography className="font-semibold text-2xl">Receipt </Typography>

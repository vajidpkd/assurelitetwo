...
// import { getAllParty } from 'apis/api';
...
const AddReceipt = () => {
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.post('https://assurelite.datacubeglobal.com/Api/index.php/Entries/add_Receipt', data, {
          headers: {
  ...
  return (
 <MainCard>
        <div className="container mx-auto rounded-md bg-white "></div>
